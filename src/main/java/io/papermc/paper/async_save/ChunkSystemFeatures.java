package io.papermc.paper.async_save;
...
public final class ChunkSystemFeatures {
    public static boolean supportsAsyncChunkSave() {
        ...
        return GoldenForgeConfig.Server.asynchronousSave.get();
    }
    ...
    public static CompoundTag saveChunkAsync(final ServerLevel world, final ChunkAccess chunk) {
