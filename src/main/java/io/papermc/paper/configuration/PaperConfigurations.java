...
import io.papermc.paper.configuration.serializer.collections.*;
import io.papermc.paper.configuration.serializer.registry.*;
import io.papermc.paper.configuration.transformation.*;
import io.papermc.paper.configuration.transformation.global.versioned.*;
...
public class PaperConfigurations extends Configurations<GlobalConfiguration, WorldConfiguration> {
    ...
    private static ContextMap createWorldContextMap(ServerLevel level) {
        return createWorldContextMap(level.levelStorageAccess.levelDirectory.path(), level.serverLevelData.getLevelName(), level.dimension().location(), level.registryAccess(), level.getGameRules());
    }
